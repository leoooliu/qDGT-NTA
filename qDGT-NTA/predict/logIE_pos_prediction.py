# -*- coding: utf-8 -*-
"""
Created on Wed Mar 26 17:34:40 2025
...
def generate_features(smiles):
    ...
    # 融合特征
    features = np.concatenate([rdkit_desc,mordred_features])  
    return features

def predict_smiles(input_file,output_file):    
    model = joblib.load('models/logIE_pos_XGBOOST.pkl')
    ...
    # 保存预测结果
    new_data['Predicted_logIE_POS'] = predictions
